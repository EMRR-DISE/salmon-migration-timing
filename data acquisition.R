...
# https://doi.org/10.6073/pasta/30a3232084be9c936c976fbb6b31c5a2 (Accessed 2022-08-10)

source("edi.244.9.5")
# Use script edi.244.9.r from above to access data (also in 'phenology' folder);
# the data should now be loaded into your workspace, plus some junk...
...
dim(trawls %>% filter(iep_fish_code == "CHISAL" & fork_length < 250))
# CHN >= 250 mm are 0.00094 of the total CHN (465/494,875 2022-04-28)
# CHN <= 55 mm (n=38,869) are 0.078 of the total CHN

dim(trawls) # 1,377,923 rows x 32 columns
...
# available at EDI provide no helpful information on how to select a reasonable range
...
# limited ts here: 2016-12-16 to 2021-06-03
# note that wy 2021 is incomplete tho may not matter
